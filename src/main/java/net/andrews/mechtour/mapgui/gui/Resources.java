...
public class Resources {
    ...
    public static BitMapImage map_icon = new BitMapImage("map_icon.png").scaledDimensions(-1, 100).setAlphaCutoff(250)
            .bake();
    public static MapText map_text = new MapText("Open Map", new Font("Arial", Font.PLAIN, 40));

    public static BitMapImage about_icon = new BitMapImage("about_icon.png").scaledDimensions(-1, 100)
            .setAlphaCutoff(250).bake();
